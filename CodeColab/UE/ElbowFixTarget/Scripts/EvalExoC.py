...
def plotFlexAngleExo():
    a = np.loadtxt('CodeColab/UE/ElbowFixTarget/ResultsData/ExoResults.csv', delimiter=',')
    plt.figure()
    #print(heights)
    #sprint(energy)
    plt.scatter(a[:,1],a[:,2]) 
    ...
    plt.savefig("CodeColab/UE/ElbowFixTarget/vid_plots/TargetFlexResultsExo.png")
    plt.close()
...
model.load("MyoAssistAgent2")

data_f = open('CodeColab/UE/ElbowFixTarget/ResultsData/ExoResults.csv' ,"w")
